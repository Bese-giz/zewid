...
export default function HomePage() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative flex min-h-[72vh] items-center justify-center md:min-h-[90vh]">
        <div
        ...
        <div className="relative z-10 mx-auto max-w-3xl px-5 text-center sm:px-6">
          <div className="mb-4 inline-block rounded-full border border-white/20 bg-white/10 px-3 py-1 backdrop-blur-md md:mb-6">
            <span className="text-white/90 text-[11px] md:text-sm font-medium">🇪🇹 Authentic Ethiopian Products in Finland 🇫🇮</span>
          </div>
          <h1 className="text-[28px] md:text-5xl lg:text-6xl font-bold text-white mb-3 md:mb-5 leading-[1.2] tracking-tight">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid gap-4 md:gap-6 lg:grid-cols-3">
            {[
              ...
              <div
                key={item.step}
                className="rounded-[1.5rem] border border-white/90 bg-[linear-gradient(180deg,#ffffff_0%,#fcfaf6_100%)] p-5 shadow-[0_16px_36px_rgba(15,23,42,0.06)] md:p-6"
              >
                ...
                <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-green-50 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-green-700">
                  <span className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-green-500 text-[10px] text-white">
                    {item.step}
                  </span>
                  Step {item.step}
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 gap-3 md:gap-6 lg:grid-cols-4">
            {[
              ...
              <div
                key={item.title}
                className="rounded-xl border border-white/80 bg-[linear-gradient(180deg,#ffffff_0%,#fcfaf6_100%)] p-4 text-center shadow-[0_14px_32px_rgba(15,23,42,0.05)] transition-shadow hover:shadow-[0_18px_36px_rgba(15,23,42,0.08)] md:rounded-2xl md:p-8"
              >
                <div className="mb-2 text-3xl md:mb-4 md:text-4xl">{item.icon}</div>
                <h3 className="mb-1 text-sm font-bold text-gray-900 md:mb-2 md:text-lg">{item.title}</h3>
            ...
            <div className="relative grid items-center gap-6 md:grid-cols-[1.2fr_0.9fr] md:gap-10">
              ...
              <div className="grid gap-3 md:gap-4">
                {[
                  ...
                  <div
                    key={item.title}
                    className="rounded-2xl border border-green-100 bg-white/85 p-4 shadow-sm md:p-5"
                  >
